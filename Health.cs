...
public class Health : MonoBehaviour
{
    ...
    void Update()
    {
		...
		player_health = Blackboard.Instance.getPlayerHealth(); // added
   ...
   void OnTriggerStay(Collider other)// melee damage
    {
		if (other.gameObject.tag == "zombie")// if collider tag = "zombie'
        {
			player_health -= melee_damage;// curent health - melee damage
			Blackboard.Instance.setPlayerHealth((int)player_health - melee_damage); // added
        }
    }
